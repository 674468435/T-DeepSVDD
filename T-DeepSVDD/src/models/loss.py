...
class MTLLoss(nn.Module):
    ...
    def forward(self,
                y_pred: torch.Tensor, y_true: torch.Tensor, y_trend: torch.Tensor) -> torch.Tensor:
        """Compute the loss between a target value and a prediction, trend.
        ...
        return self.nu*self.mse_loss(y_pred, y_true) + (1-self.nu)*self.mse_loss(y_pred, y_trend)
