...
class Options(object):
    ...
    def __init__(self):
        ...
        # Training process
        self.parser.add_argument('--task', choices={"imputation", "transduction", "classification", "regression", "reconstruction", "localization"},
                                 default="imputation",
        ...
        # Misson
        self.parser.add_argument('--misson',
                                 help='misson of run code')
        self.parser.add_argument('--use_noise', type=int, default=None,
                                 help="Number of sequence which add random noise")
    def parse(self):
